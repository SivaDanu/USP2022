        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
              ...
              <p>Please Fill It Completely</p>
            </div>
            <div class="col-lg-6">
              <form action="{{route('transaction.store')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <input type="hidden" name="id" class="form-control" value="<?php echo(rand(10, 50));?>">
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="nota" class="form-control" value="<?php echo(rand(100, 1000));?>">
                    </div>
                    <div class="form-group">
                        Name :
                    ...
                    <div class="form-group">
                        <input type="hidden" name="total" value="<?php echo(rand(1000, 2000));?>">
                    </div>
                    <div class="form-group">
                        <?php
                            $date = date('Y-m-d');
