...
<body>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
        <h1 align="center">Data Type Car</h1>
            @if (Auth::user()->role_id == 1)
            ...
            <table class="table table-bordered">
                ...
                @php
                    $no = 1;
                @endphp
                @foreach ($data_typecar as $typecar)
                <tr>
                    <td>{{$no++}}</td>
                    <td>{{$typecar->typecar}}</td>
                    <td>{{$typecar->total}}</td>
                    <td>
                        <a href="{{route('typecar.edit', $typecar->id)}}">
                            <button class="btn btn-warning">Edit</button>
                        </a>
                        <form action="{{route('typecar.destroy', $typecar->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
