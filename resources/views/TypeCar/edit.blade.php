      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center">
            <h4>Edit Type Car</h4>
            <p>Please Fill It Completly</p>
          </div>
          <div class="col-lg-6">
            <form action="{{route('typecar.update', $data_typecar->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    Typecar :
                    <input type="text" name="typecar" class="form-control" value="{{$data_typecar->typecar}}">
                </div>
                <div class="form-group">
                    Total :
                    <input type="integer" name="total" class="form-control" value="{{$data_typecar->total}}">
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">Submit</button>
                    <a href="{{route('typecar.index')}}">
