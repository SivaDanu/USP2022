      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center">
            <h4>Add New Type Car</h4>
            <p>Please Fill It Completely</p>
          </div>
          <div class="col-lg-6">
            <form action="{{route('typecar.store')}}" method="POST">
                @csrf
                <div class="form-group">
                    Typecar :
                    <input type="text" name="typecar" class="form-control">
                </div>
                <div class="form-group">
                    Total :
                    <input type="integer" name="total" class="form-control">
                </div>
