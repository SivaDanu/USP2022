    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          {{-- <li>
              @if (Auth::user()->role_id == 1)
              <a class="nav-link scrollto" href="{{route('user.index')}}">Users</a>
              @endif
          </li> --}}
          ...
          <li>
            {{-- @if (Auth::user()->role_id == 1) --}}
              <a class="getstarted scrollto" href="{{route('transaction.create')}}">Lakukan Transaksi</a>
            {{-- @endif --}}
          </li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400">Kami adalah desainer yang membuat situs web dengan Bootstrap</h2>
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
                {{-- @if (Auth::user()->role_id == 1) --}}
                  <a href="{{route('transaction.create')}}" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
